...
<?php
/*
 * This is a sample callback function for PHPMailer Lite. This callback function
 * will echo the results of PHPMailer processing.
 */
...
{
    /*
     * this callback example echos the results to the screen - implement to post
     * to databases, build CSV log files, etc., with minor changes
     */
    $to = cleanEmails($to, 'to');
    $cc = cleanEmails($cc[0], 'cc');
    $bcc = cleanEmails($bcc[0], 'cc');
    echo $result . "\tTo: " . $to['Name'] . "\tTo: " . $to['Email'] . "\tCc: " .
             $cc['Name'] . "\tCc: " . $cc['Email'] . "\tBcc: " . $bcc['Name'] .
             "\tBcc: " . $bcc['Email'] . "\t" . $subject . "<br />\n";
    return true;
}
