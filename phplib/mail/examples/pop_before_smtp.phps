...
// Passing true to the constructor enables the use of exceptions for error
// handling
...
try {
    ...
    // Send the message
    // Note that we don't need check the response from this because it will
    // throw an exception if it has trouble
    $mail->Send();
    echo "Message sent!";
