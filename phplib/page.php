	...
	class Page {
		...
		*/
		...
		private function displayRightHeader() {
			...
			elseif (isset($_SESSION['user_level']) && $_SESSION['user_level'] >= $this->privilege){
				$this->displayContent();
			}
			else {
		...
		private function displayModals() {
			...
			if(isset($_POST['username']))
				echo '<input type="text" placeholder="Username/Email" value="'.$_POST['username'].'" name="username_login">';
			else
